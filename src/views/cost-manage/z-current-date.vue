<template>
  <div class="s-month-container" style="display: inline-block;">
    ...
    <el-date-picker v-if="type=='month'" type="month" format="yyyy年MM月" v-model="currentDate" class="inputWidth"></el-date-picker>
    <el-date-picker v-if="type=='year'" type="year" format="yyyy年" v-model="currentDate" class="inputWidth"></el-date-picker>
